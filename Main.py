...
El patrón Singleton asegura que solo haya una instancia de una clase en toda la ejecución del programa. En este caso, se utiliza para garantizar que solo haya una instancia de la página en la aplicación, lo que facilita su gestión y actualización.
